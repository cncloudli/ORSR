...
os.environ["PYTORCH_CUDA_ALLOC_CONF"] = 'max_split_size_mb:3900'
def main():
    parser = ArgumentParser()
    parser.add_argument('--mse_root', help='Root of MSE images',
                        default='desra/artifact_datasets/mse')
    parser.add_argument('--gan_root', help='Root of GAN images',
                        default='desra/artifact_datasets/gan')
    parser.add_argument('--save_root', help='Path to output file', default='desra/outputs')
    parser.add_argument('--semantic_interval_txt', default='desra/SSIM_MSE_GAN_threshold.txt')
    ...
    parser.add_argument(
        ...
        default='configs/segformer/segformer_mit-b5_8xb2-160k_ade20k-640x640.py')
    parser.add_argument(
        '--checkpoint',
        help='Checkpoint file',
        default='desra/segformer_mit-b5_640x640_160k_ade20k_20220617_203542-940a6bd8.pth')
    ...
    for img_name in sorted(os.listdir(args.mse_root)):

            mse_img_path = os.path.join(args.mse_root, img_name)
            gan_img_path = os.path.join(args.gan_root, img_name)

            print('We are processing: ', f'{img_name}')
            ...
            save_seg_mask_root = os.path.join(args.save_root, 'seg')
            ...
            try:
                ...
                save_contrast_root = os.path.join(args.save_root, 'rgb_contrast')
                ...
                save_contrast_seg_root = os.path.join(args.save_root, 'rgb_contrast_seg')
                ...
                save_final_mask_root = os.path.join(args.save_root, 'Final_Artifact_Map')
                os.makedirs(save_final_mask_root, exist_ok=True)
                save_final_mask_path = os.path.join(save_final_mask_root, img_name)
